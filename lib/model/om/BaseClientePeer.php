...
abstract class BaseClientePeer {
	...
	const ID_PROV = 'cliente.ID_PROV';

	/** the column name for the ID_CIUDAD field */
	const ID_CIUDAD = 'cliente.ID_CIUDAD';
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(ClientePeer::ID_CLIE);
			$criteria->addSelectColumn(ClientePeer::APELLIDO);
	...
	public static function doCountJoinCiudadRelatedByIdProv(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ClientePeer::ID_PROV, CiudadPeer::ID_PROVINCIA, $join_behavior);
	...
	public static function doCountJoinCiudadRelatedByIdCiudad(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ClientePeer::ID_CIUDAD, CiudadPeer::IDCIUDAD, $join_behavior);
	...
	public static function doSelectJoinCiudadRelatedByIdProv(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				$obj2->addClienteRelatedByIdProv($obj1);
	...
	public static function doSelectJoinCiudadRelatedByIdCiudad(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Cliente) to $obj2 (Ciudad)
				$obj2->addClienteRelatedByIdCiudad($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Cliente) to the collection in $obj3 (Ciudad)
				$obj3->addClienteRelatedByIdCiudad($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of Cliente objects pre-filled with all related objects except CiudadRelatedByIdProv.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(ClientePeer::ID_CLIE) && $criteria->keyContainsValue(ClientePeer::ID_CLIE) ) {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ClientePeer::ID_CLIE);
			$value = $criteria->remove(ClientePeer::ID_CLIE);
			if ($value) {
				$selectCriteria->add(ClientePeer::ID_CLIE, $value, $comparison);
			} else {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(ClientePeer::ID_CLIE, (array) $values, Criteria::IN);
		}
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(VentaPeer::IDCLIENTE, $obj->getIdClie());
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(ClientePeer::ID_CLIE, $pk);
