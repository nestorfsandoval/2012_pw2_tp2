...
abstract class BaseProveedorPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Idproveedor', 'Nombre', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idproveedor', 'nombre', ),
		BasePeer::TYPE_COLNAME => array (self::IDPROVEEDOR, self::NOMBRE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('IDPROVEEDOR', 'NOMBRE', ),
		BasePeer::TYPE_FIELDNAME => array ('idproveedor', 'nombre', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Idproveedor' => 0, 'Nombre' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idproveedor' => 0, 'nombre' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::IDPROVEEDOR => 0, self::NOMBRE => 1, ),
		BasePeer::TYPE_RAW_COLNAME => array ('IDPROVEEDOR' => 0, 'NOMBRE' => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('idproveedor' => 0, 'nombre' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	{
		// Invalidate objects in RegistrocompraPeer instance pool,
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Registrocompra objects
			$criteria = new Criteria(RegistrocompraPeer::DATABASE_NAME);
			
			$criteria->add(RegistrocompraPeer::IDPROVEE, $obj->getIdproveedor());
			$affectedRows += RegistrocompraPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
	...
	{
	  return array(array('idproveedor'));
	}
