 ...
 * 
 *
 * @method     ProvinciaQuery orderByIdprovincia($order = Criteria::ASC) Order by the idprovincia column
 * @method     ProvinciaQuery orderByProvincia($order = Criteria::ASC) Order by the provincia column
 *
 * @method     ProvinciaQuery groupByIdprovincia() Group by the idprovincia column
 * @method     ProvinciaQuery groupByProvincia() Group by the provincia column
 *
 ...
 *
 * @method     ProvinciaQuery leftJoinCiudad($relationAlias = null) Adds a LEFT JOIN clause to the query using the Ciudad relation
 * @method     ProvinciaQuery rightJoinCiudad($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Ciudad relation
 * @method     ProvinciaQuery innerJoinCiudad($relationAlias = null) Adds a INNER JOIN clause to the query using the Ciudad relation
 *
 ...
 *
 * @method     Provincia findOneByIdprovincia(int $idprovincia) Return the first Provincia filtered by the idprovincia column
 * @method     Provincia findOneByProvincia(string $provincia) Return the first Provincia filtered by the provincia column
 *
 * @method     array findByIdprovincia(int $idprovincia) Return Provincia objects filtered by the idprovincia column
 * @method     array findByProvincia(string $provincia) Return Provincia objects filtered by the provincia column
 *
...
abstract class BaseProvinciaQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `IDPROVINCIA`, `PROVINCIA` FROM `provincia` WHERE `IDPROVINCIA` = :p0';
		try {
	...
	{
		return $this->addUsingAlias(ProvinciaPeer::IDPROVINCIA, $key, Criteria::EQUAL);
	}
	...
	{
		return $this->addUsingAlias(ProvinciaPeer::IDPROVINCIA, $keys, Criteria::IN);
	}

	/**
	 * Filter the query on the idprovincia column
	 *
	 * Example usage:
	 * <code>
	 * $query->filterByIdprovincia(1234); // WHERE idprovincia = 1234
	 * $query->filterByIdprovincia(array(12, 34)); // WHERE idprovincia IN (12, 34)
	 * $query->filterByIdprovincia(array('min' => 12)); // WHERE idprovincia > 12
	 * </code>
	 *
	...
	public function filterByIdprovincia($idprovincia = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(ProvinciaPeer::IDPROVINCIA, $idprovincia, $comparison);
	}
	...
	public function filterByProvincia($provincia = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(ProvinciaPeer::PROVINCIA, $provincia, $comparison);
	}
	...
	public function filterByCiudad($ciudad, $comparison = null)
	{
		if ($ciudad instanceof Ciudad) {
			return $this
				->addUsingAlias(ProvinciaPeer::IDPROVINCIA, $ciudad->getIdProvincia(), $comparison);
