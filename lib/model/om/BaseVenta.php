...
abstract class BaseVenta extends BaseObject  implements Persistent
{
	...
	public function setIdcliente($v)
	{
		...
		if ($this->aCliente !== null && $this->aCliente->getIdClie() !== $v) {
			$this->aCliente = null;
		}
	...
	public function setIdproducto($v)
	{
		...
		if ($this->idproducto !== $v) {
			$this->idproducto = $v;
			$this->modifiedColumns[] = VentaPeer::IDPRODUCTO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->idcliente = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			return $startcol + 4; // 4 = VentaPeer::NUM_HYDRATE_COLUMNS.
	...
	public function ensureConsistency()
	{
		...
		if ($this->aCliente !== null && $this->idcliente !== $this->aCliente->getIdClie()) {
			$this->aCliente = null;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(VentaPeer::IDPRODUCTO)) $criteria->add(VentaPeer::IDPRODUCTO, $this->idproducto);
