...
abstract class BaseVentaPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Idventa', 'Fecha', 'Idcliente', 'Idproducto', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idventa', 'fecha', 'idcliente', 'idproducto', ),
		BasePeer::TYPE_COLNAME => array (self::IDVENTA, self::FECHA, self::IDCLIENTE, self::IDPRODUCTO, ),
		BasePeer::TYPE_RAW_COLNAME => array ('IDVENTA', 'FECHA', 'IDCLIENTE', 'IDPRODUCTO', ),
		BasePeer::TYPE_FIELDNAME => array ('idventa', 'fecha', 'idcliente', 'idproducto', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Idventa' => 0, 'Fecha' => 1, 'Idcliente' => 2, 'Idproducto' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idventa' => 0, 'fecha' => 1, 'idcliente' => 2, 'idproducto' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::IDVENTA => 0, self::FECHA => 1, self::IDCLIENTE => 2, self::IDPRODUCTO => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('IDVENTA' => 0, 'FECHA' => 1, 'IDCLIENTE' => 2, 'IDPRODUCTO' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('idventa' => 0, 'fecha' => 1, 'idcliente' => 2, 'idproducto' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(VentaPeer::IDPRODUCTO);
		} else {
	...
	public static function doCountJoinCliente(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(VentaPeer::IDCLIENTE, ClientePeer::ID_CLIE, $join_behavior);
	...
	public static function doCountJoinProducto(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(VentaPeer::IDPRODUCTO, ProductoPeer::IDPRODUCTO, $join_behavior);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Venta) to the collection in $obj3 (Producto)
				$obj3->addVenta($obj1);
			} // if joined row not null
